...
### Governance layer
A repo-local set of rules, project intent, specs, workflow expectations, and evidence standards that guide how humans and agents deliver software. See [Overview](/docs/intro) and [The VibeGov SDLC](/docs/vibegov-sdlc).

### Source of truth
The canonical place a project expects agents and humans to read from before acting. In VibeGov, `.governance/` is the governance source of truth. See [Overview](/docs/intro).
