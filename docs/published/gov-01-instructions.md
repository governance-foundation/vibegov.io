...
- Source rule: [gov-01-instructions.mdc](https://github.com/governance-foundation/vibegov/blob/main/.governance/rules/gov-01-instructions.mdc)
- Download raw file: [gov-01-instructions.mdc](https://raw.githubusercontent.com/governance-foundation/vibegov/main/.governance/rules/gov-01-instructions.mdc)
...
- **Scope**: Index and entry point to governance and project guidance files.
- **Audience**: Anyone orienting to the guidance set.
- **Update Cadence**: Update when files are added, removed, or renamed.
...
**For core workflow principles and autonomous execution rules, see [gov-02-workflow.mdc](https://github.com/governance-foundation/vibegov/blob/main/.governance/rules/gov-02-workflow.mdc)**
...
- [gov-02-workflow.mdc](https://github.com/governance-foundation/vibegov/blob/main/.governance/rules/gov-02-workflow.mdc) - Core workflow principles
